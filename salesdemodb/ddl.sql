...
CREATE TABLE `art_log_events_t` ( id VARCHAR(64) NOT NULL, eventDate DATETIME DEFAULT NULL, alarmId VARCHAR(15) DEFAULT NULL, customerId VARCHAR(64) DEFAULT NULL, userId VARCHAR(64) DEFAULT NULL, userIpAddress VARCHAR(20) DEFAULT NULL, userPort INT(10) DEFAULT NULL, geoLatitude DOUBLE DEFAULT NULL, geoLongitude DOUBLE DEFAULT NULL, sessionId VARCHAR(64) DEFAULT NULL, requestId VARCHAR(64) DEFAULT NULL, boundedContextId VARCHAR(5) DEFAULT NULL, domainId VARCHAR(5) DEFAULT NULL, className VARCHAR(500) DEFAULT NULL, methodName VARCHAR(200) DEFAULT NULL, message VARCHAR(4000) DEFAULT NULL, exception VARCHAR(2000) DEFAULT NULL, context INT(5) DEFAULT NULL, severity INT(5) DEFAULT NULL, layer INT(5) DEFAULT NULL, eventAction INT(5) DEFAULT NULL, alarmStatus INT(5) DEFAULT NULL, PRIMARY KEY (id), CONSTRAINT fk_severity FOREIGN KEY (severity) REFERENCES art_log_severity_m (severityId), CONSTRAINT fk_layer FOREIGN KEY (layer) REFERENCES art_log_architecture_layer_m (layerId), CONSTRAINT fk_event_action FOREIGN KEY (eventAction) REFERENCES art_log_event_action_m (eventActionId), CONSTRAINT fk_status FOREIGN KEY (alarmStatus) REFERENCES art_log_status_m (statusId));
...
CREATE TABLE `ast_LoginSession_T` ( `AppSessionId` VARCHAR(256) NOT NULL, `userId` VARCHAR(64) NOT NULL, `AppServerSessionId` VARCHAR(256) NOT NULL, `loginTime` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, `logoutTime` TIMESTAMP NULL, `lastAccessTime` TIMESTAMP NULL DEFAULT NULL, `clientIPAddress` VARCHAR(128) NOT NULL, `clientIPAddressInt` BIGINT NULL DEFAULT NULL, `clientNetworkAddress` INT(11) NULL DEFAULT NULL, `clientBrowser` VARCHAR(256) NOT NULL, `sessionData` TEXT NULL DEFAULT NULL, `createdBy` VARCHAR(64) NULL DEFAULT '-1', `createdDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `updatedBy` VARCHAR(64) NULL DEFAULT '-1', `updatedDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `versionId` INT(10) NULL DEFAULT '-1', `activeStatus` INT(1) NULL DEFAULT '1', `txnAccessCode` INT(10) NULL DEFAULT NULL, PRIMARY KEY (`AppSessionId`));
...
CREATE TABLE `ast_UserAppState_T` ( `appStateId` VARCHAR(64) NOT NULL, `AppSessionId` VARCHAR(256) NOT NULL, `TabId` VARCHAR(11) NOT NULL, `isActive` INT(11) NOT NULL DEFAULT '0', `sessionDataType` VARCHAR(11) NULL DEFAULT NULL, `sessionData` VARCHAR(4000) NULL DEFAULT NULL, `createdBy` VARCHAR(64) NULL DEFAULT '-1', `createdDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `updatedBy` VARCHAR(64) NULL DEFAULT '-1', `updatedDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `versionId` INT(10) NULL DEFAULT '-1', `activeStatus` INT(1) NULL DEFAULT '1', `txnAccessCode` INT(10) NULL DEFAULT NULL, PRIMARY KEY (`appStateId`));
...
CREATE TABLE `ast_Category_M` ( `categoryId` VARCHAR(64) NOT NULL, `categoryInformation` VARCHAR(64) NOT NULL, `createdBy` VARCHAR(64) NULL DEFAULT '-1', `createdDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `updatedBy` VARCHAR(64) NULL DEFAULT '-1', `updatedDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `versionId` INT(10) NULL DEFAULT '-1', `activeStatus` INT(1) NULL DEFAULT '1', `txnAccessCode` INT(10) NULL DEFAULT NULL, PRIMARY KEY (`categoryId`));
...
ALTER TABLE `ast_Material_M` ADD CONSTRAINT FOREIGN KEY (`brandcode`) REFERENCES `ast_Brand_M`(`brandcode`);
...
ALTER TABLE `ast_Distributor_M` ADD CONSTRAINT FOREIGN KEY (`regioncode`) REFERENCES `ast_SalesRegion_M`(`regioncode`);
...
ALTER TABLE `ast_Retailer_M` ADD CONSTRAINT FOREIGN KEY (`distributorcode`) REFERENCES `ast_Distributor_M`(`distributorcode`);

DROP TABLE IF EXISTS `ast_SalesData_T`;

CREATE TABLE `ast_SalesData_T` ( `autoid` INT(10) NOT NULL AUTO_INCREMENT, `channelId` VARCHAR(64) NOT NULL, `reatilercode` VARCHAR(64) NOT NULL, `retailername` VARCHAR(64) NULL DEFAULT NULL, `salesdate` DATE NOT NULL, `salesmonth` INT(10) NOT NULL, `salesyear` INT(10) NOT NULL, `salesinvoicenbr` VARCHAR(64) NOT NULL, `materialdescription` VARCHAR(64) NULL DEFAULT NULL, `branddescription` VARCHAR(64) NULL DEFAULT NULL, `salesqty` DOUBLE(10,2) NOT NULL, `netsalesamt` DOUBLE(10,2) NOT NULL, `grosssalesamt` DOUBLE(10,2) NOT NULL, `materialcode` VARCHAR(64) NOT NULL, `brandcode` VARCHAR(64) NOT NULL, `categoryId` VARCHAR(64) NOT NULL, `createdBy` VARCHAR(64) NULL DEFAULT '-1', `createdDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `updatedBy` VARCHAR(64) NULL DEFAULT '-1', `updatedDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `versionId` INT(10) NULL DEFAULT '-1', `activeStatus` INT(1) NULL DEFAULT '1', `txnAccessCode` INT(10) NULL DEFAULT NULL, PRIMARY KEY (`autoid`));
...
ALTER TABLE `ast_SalesData_T` ADD CONSTRAINT FOREIGN KEY (`categoryId`) REFERENCES `ast_Category_M`(`categoryId`);
