Ext.define('Salesdemo.view.smartdevice.reportview.querycriteria.QueryCriteriaController',{
	extend :'Salesdemo.view.smartdevice.reportview.ReportMainViewController',
