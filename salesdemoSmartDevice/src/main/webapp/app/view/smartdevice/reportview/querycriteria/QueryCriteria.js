Ext.define('Salesdemo.view.smartdevice.reportview.querycriteria.QueryCriteria', {
	extend : 'Ext.panel.Panel',
	requires:['Salesdemo.view.smartdevice.reportview.querycriteria.QueryCriteriaController'],
