...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "3", comments = "ContactType", complexity = Complexity.LOW)
...
public class ContactType implements Serializable, CommonEntityInterface, Comparator<ContactType> {
    ...
    public boolean equals(Object obj) {
        try {
            com.sales.app.shared.organization.contactmanagement.ContactType other = (com.sales.app.shared.organization.contactmanagement.ContactType) obj;
            if (contactTypeId == null) {
                return false;
