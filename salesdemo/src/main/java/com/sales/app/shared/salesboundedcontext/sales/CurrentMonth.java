...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "3", comments = "CurrentMonth", complexity = Complexity.LOW)
...
public class CurrentMonth implements Serializable, CommonEntityInterface, Comparator<CurrentMonth> {
    ...
    public boolean equals(Object obj) {
        try {
            com.sales.app.shared.salesboundedcontext.sales.CurrentMonth other = (com.sales.app.shared.salesboundedcontext.sales.CurrentMonth) obj;
            if (monthid == null) {
                return false;
