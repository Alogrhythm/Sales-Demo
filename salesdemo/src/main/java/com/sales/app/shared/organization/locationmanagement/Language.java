package com.sales.app.shared.organization.locationmanagement;
...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "3", comments = "Language", complexity = Complexity.LOW)
...
public class Language implements Serializable, CommonEntityInterface, Comparator<Language> {
    ...
    public boolean equals(Object obj) {
        try {
            com.sales.app.shared.organization.locationmanagement.Language other = (com.sales.app.shared.organization.locationmanagement.Language) obj;
            if (languageId == null) {
                return false;
