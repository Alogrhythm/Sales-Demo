...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "3", comments = "AppMenus", complexity = Complexity.LOW)
...
public class AppMenus implements Serializable, CommonEntityInterface, Comparator<AppMenus> {
    ...
    public boolean equals(Object obj) {
        try {
            com.sales.app.shared.appbasicsetup.userrolemanagement.AppMenus other = (com.sales.app.shared.appbasicsetup.userrolemanagement.AppMenus) obj;
            if (menuId == null) {
                return false;
