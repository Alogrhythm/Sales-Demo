...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "3", comments = "UserAccess", complexity = Complexity.LOW)
...
public class UserAccess implements Serializable, CommonEntityInterface, Comparator<UserAccess> {
    ...
    public boolean equals(Object obj) {
        try {
            com.sales.app.shared.salesboundedcontext.sales.UserAccess other = (com.sales.app.shared.salesboundedcontext.sales.UserAccess) obj;
            if (userAccessId == null) {
                return false;
