...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "3", comments = "Channel", complexity = Complexity.LOW)
...
public class Channel implements Serializable, CommonEntityInterface, Comparator<Channel> {
    ...
    @Column(name = "channelInformation")
    ...
    public void setChannelInformation(String _channelInformation) {
        if (_channelInformation != null) {
            this.channelInformation = _channelInformation;
        }
    }
    ...
    public String getPrimaryDisplay() {
        ...
        sb.append("");
        sb.append((channelInformation == null ? " " : channelInformation));
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        try {
            com.sales.app.shared.salesboundedcontext.sales.Channel other = (com.sales.app.shared.salesboundedcontext.sales.Channel) obj;
            if (channelId == null) {
                return false;
