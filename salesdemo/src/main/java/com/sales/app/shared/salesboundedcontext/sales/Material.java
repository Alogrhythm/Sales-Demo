...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "3", comments = "Material", complexity = Complexity.LOW)
...
public class Material implements Serializable, CommonEntityInterface, Comparator<Material> {
    ...
    public boolean equals(Object obj) {
        try {
            com.sales.app.shared.salesboundedcontext.sales.Material other = (com.sales.app.shared.salesboundedcontext.sales.Material) obj;
            if (materialcode == null) {
                return false;
