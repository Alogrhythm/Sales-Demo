...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "3", comments = "Login", complexity = Complexity.LOW)
...
public class Login implements Serializable, CommonEntityInterface, UserAuthentication, Comparator<Login> {
    ...
    public boolean equals(Object obj) {
        try {
            com.sales.app.shared.appbasicsetup.usermanagement.Login other = (com.sales.app.shared.appbasicsetup.usermanagement.Login) obj;
            if (loginPk == null) {
                return false;
