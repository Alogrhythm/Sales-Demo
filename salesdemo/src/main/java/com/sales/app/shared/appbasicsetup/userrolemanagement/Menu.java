...
public class Menu {
	...
	public Menu(String menuId, String menuTreeId, String menuName, String menuAction, String menuIcon, String userId, String menuLabel, String menuCommands, String refId,
			boolean autoSave) {
		super();
		this.menuId = menuId;
		this.menuTreeId = menuTreeId;
