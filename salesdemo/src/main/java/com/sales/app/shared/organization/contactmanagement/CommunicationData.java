...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "3", comments = "CommunicationData", complexity = Complexity.LOW)
...
public class CommunicationData implements Serializable, CommonEntityInterface, Comparator<CommunicationData> {
    ...
    public boolean equals(Object obj) {
        try {
            com.sales.app.shared.organization.contactmanagement.CommunicationData other = (com.sales.app.shared.organization.contactmanagement.CommunicationData) obj;
            if (commDataId == null) {
                return false;
