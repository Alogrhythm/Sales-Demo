package com.sales.app.shared.appinsight.alarms;
...
public class AppLogConfig {
	 ...
	 * "AppLogConfig [alarmSeverity = " + alarmSeverity + ", connectorArray = "
	 * + connectorArray + ", LoggingProperties = " + loggingProperties + "]"; }
	 */
}
