...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "3", comments = "City", complexity = Complexity.LOW)
...
public class City implements Serializable, CommonEntityInterface, Comparator<City> {
    ...
    public boolean equals(Object obj) {
        try {
            com.sales.app.shared.organization.locationmanagement.City other = (com.sales.app.shared.organization.locationmanagement.City) obj;
            if (cityId == null) {
                return false;
