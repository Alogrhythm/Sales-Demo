...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "3", comments = "Address", complexity = Complexity.LOW)
...
public class Address implements Serializable, CommonEntityInterface, Comparator<Address> {
    ...
    public boolean equals(Object obj) {
        try {
            com.sales.app.shared.organization.locationmanagement.Address other = (com.sales.app.shared.organization.locationmanagement.Address) obj;
            if (addressId == null) {
                return false;
