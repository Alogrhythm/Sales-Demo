...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "3", comments = "User", complexity = Complexity.LOW)
...
public class User implements Serializable, CommonEntityInterface, UserInterface, Comparator<User> {
    ...
    public User addPassRecovery(PassRecovery _passRecovery) {
        if (this.passRecovery == null) {
            this.passRecovery = new java.util.ArrayList<com.sales.app.shared.appbasicsetup.usermanagement.PassRecovery>();
        }
    ...
    public boolean equals(Object obj) {
        try {
            com.sales.app.shared.appbasicsetup.usermanagement.User other = (com.sales.app.shared.appbasicsetup.usermanagement.User) obj;
            if (userId == null) {
                return false;
