...
public class CommunicationGroup implements Serializable, CommonEntityInterface, Comparator<CommunicationGroup> {
    ...
    public boolean equals(Object obj) {
        try {
            com.sales.app.shared.organization.contactmanagement.CommunicationGroup other = (com.sales.app.shared.organization.contactmanagement.CommunicationGroup) obj;
            if (commGroupId == null) {
                return false;
