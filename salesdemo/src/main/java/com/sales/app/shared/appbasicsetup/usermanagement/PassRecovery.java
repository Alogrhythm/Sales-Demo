...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "4", comments = "PassRecovery", complexity = Complexity.LOW)
...
public class PassRecovery implements Serializable, CommonEntityInterface, PassRecoveryInterface, Comparator<PassRecovery> {
    ...
    public boolean equals(Object obj) {
        try {
            com.sales.app.shared.appbasicsetup.usermanagement.PassRecovery other = (com.sales.app.shared.appbasicsetup.usermanagement.PassRecovery) obj;
            if (passRecoveryId == null) {
                return false;
