package com.sales.app.config.appSetup.xmlParser;
import com.sales.app.config.appSetup.model.AppConfiguration;

import com.sales.app.config.appSetup.model.AuthPlugin;

import com.sales.app.config.appSetup.model.AuthenticationConfig;

import com.sales.app.config.appSetup.model.ConnectionConfig;

import com.sales.app.config.appSetup.model.ConnectionPooling;

import com.sales.app.config.appSetup.model.ConnectorConfig;

import com.sales.app.config.appSetup.model.DatabaseConfig;

import com.sales.app.config.appSetup.model.DriveProperties;

import com.sales.app.config.appSetup.model.MailConfig;

import com.sales.app.config.appSetup.model.PathConfig;

import com.sales.app.config.appSetup.model.SchedulerConfig;

import com.sales.app.config.appSetup.model.SearchEngineConfig;

import com.sales.app.config.appSetup.model.JpaProperties;
...
public class AppSetupSAXParser extends AbstractSAXParser {
	...
	private List<JpaProperties> listOfJpaProperties = new ArrayList<JpaProperties>();
	...
	public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException {
		...
		if (qName.equalsIgnoreCase("property")) {
			this.jpaPropertyName = attributes.getValue("name");
			this.jpaPropertyValue = attributes.getValue("value");
		}
	}
	...
	public void endElement(String uri, String localName, String qName) throws SAXException {
		...
		case "property": // creation of objects
			listOfJpaProperties.add(new JpaProperties(this.jpaPropertyName, this.jpaPropertyValue));
			break;
		...
		case "connectorConfig":
			ConnectorConfig connectorConfig = new ConnectorConfig(serverId, serverName, ipAddress, portNo, databaseName, userName, password, connectorType, protocol, filePath,
					databaseType, databaseDriverName, databaseUrl);
			this.connectionConfigList.add(connectorConfig);
			break;
		case "AppConfig":
			this.appConfiguration = new AppConfiguration(pathConfig, authenticationConfig, databaseConfig, searchEngineConfig, driveProperties, mailConfig, schedulerConfig,
					connectionConfigList, listOfJpaProperties);
			break;
		default:
			break;
		}
