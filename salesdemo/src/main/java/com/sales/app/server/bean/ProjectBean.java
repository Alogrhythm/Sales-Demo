package com.sales.app.server.bean;
...
public class ProjectBean {
	...
	public ProjectBean(int projectId, String projectName, String projectDesc, String domainName, int databaseId, String schemaName, String userId, String password,
			ArrayList<Integer> components, String email) {
		super();
