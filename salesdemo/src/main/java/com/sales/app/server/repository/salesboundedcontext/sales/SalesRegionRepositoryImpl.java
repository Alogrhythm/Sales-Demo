...
@Repository
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "2", comments = "Repository for SalesRegion Master table Entity", complexity = Complexity.LOW)
public class SalesRegionRepositoryImpl extends SearchInterfaceImpl implements SalesRegionRepository<SalesRegion> {
    ...
    public List<SalesRegion> findAll() throws Exception {
        ...
        java.util.List<com.sales.app.shared.salesboundedcontext.sales.SalesRegion> query = emanager.createQuery("select u from SalesRegion u where u.systemInfo.activeStatus=1").getResultList();
    ...
    public List<SalesRegion> save(List<SalesRegion> entity) throws Exception {
        ...
        for (int i = 0; i < entity.size(); i++) {
            com.sales.app.shared.salesboundedcontext.sales.SalesRegion obj = entity.get(i);
    ...
    public void delete(String id) throws Exception {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        com.sales.app.shared.salesboundedcontext.sales.SalesRegion s = emanager.find(com.sales.app.shared.salesboundedcontext.sales.SalesRegion.class, id);
        emanager.remove(s);
    ...
    public SalesRegion findById(String regioncode) throws Exception {
        ...
        com.sales.app.shared.salesboundedcontext.sales.SalesRegion listOfSalesRegion = (com.sales.app.shared.salesboundedcontext.sales.SalesRegion) query.getSingleResult();
