...
public class TitleServiceImpl extends TitleService {
    ...
    public HttpEntity<ResponseBean> findAll() throws Exception {
        java.util.List<com.sales.app.shared.organization.contactmanagement.Title> lsttitle = titlerepo.findAll();
    ...
    public HttpEntity<ResponseBean> findById(@RequestBody FindByBean findByBean) throws Exception {
        ...
        com.sales.app.shared.organization.contactmanagement.Title lsttitle = titlerepo.findById((java.lang.String) findByBean.getFindKey());
        AppAlarm appAlarm = Log.getAlarm("ORGCM124990200");
