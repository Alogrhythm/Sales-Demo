...
@RestController
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "2", comments = "Service for Brand Master table Entity", complexity = Complexity.LOW)
...
public class BrandServiceImpl extends BrandService {
    ...
    public HttpEntity<ResponseBean> findAll() throws Exception {
        java.util.List<com.sales.app.shared.salesboundedcontext.sales.Brand> lstbrand = brandrepo.findAll();
    ...
    public HttpEntity<ResponseBean> findByCategoryId(@RequestBody FindByBean findByBean) throws Exception {
        ...
        List<com.sales.app.shared.salesboundedcontext.sales.Brand> lstbrand = brandrepo.findByCategoryId((java.lang.String) findByBean.getFindKey());
        AppAlarm appAlarm = Log.getAlarm("SBCSA124100200");
    ...
    public HttpEntity<ResponseBean> findById(@RequestBody FindByBean findByBean) throws Exception {
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        com.sales.app.shared.salesboundedcontext.sales.Brand lstbrand = brandrepo.findById((java.lang.String) findByBean.getFindKey());
        AppAlarm appAlarm = Log.getAlarm("SBCSA124100200");
        com.athena.server.pluggable.utils.bean.ResponseBean responseBean = new ResponseBean(appAlarm);
        responseBean.add("message", String.format(appAlarm.getMessage(), "Brand"));
        responseBean.add("data", lstbrand);
