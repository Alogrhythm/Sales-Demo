package com.sales.app.server.service.datavisualizer.searchengine;
...
public class SearchEngineService {
	...
	public HttpEntity<ResponseBean> getSearchResult(HttpServletRequest request, HttpServletResponse response) throws IOException, JSONException {
		...
		try {
			...
			APICaller caller = new APICaller(appconfig.getSearchEngineConfig().getSearchAppURL() + "secure/SearchEngineController/getSearchResult?searchString=" + queryParam
					+ "&oprationType=" + language, "POST");
