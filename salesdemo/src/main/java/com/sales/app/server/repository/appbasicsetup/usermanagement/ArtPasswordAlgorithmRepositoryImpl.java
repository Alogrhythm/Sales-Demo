...
import com.sales.app.shared.appbasicsetup.usermanagement.ArtPasswordAlgorithm;
...
public class ArtPasswordAlgorithmRepositoryImpl implements ArtPasswordAlgorithmRepository<ArtPasswordAlgorithm> {
	...
	@Override
	@Transactional
	public ArtPasswordAlgorithm save(ArtPasswordAlgorithm entity) throws Exception {
		javax.persistence.EntityManager emanager = emfResource.getResource();
	...
	@Override
	@Transactional
	public List<ArtPasswordAlgorithm> save(List<ArtPasswordAlgorithm> entity) throws Exception {
		javax.persistence.EntityManager emanager = emfResource.getResource();
