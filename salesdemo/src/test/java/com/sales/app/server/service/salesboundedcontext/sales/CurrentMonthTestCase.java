...
public class CurrentMonthTestCase extends EntityTestCriteria {
    ...
    private CurrentMonth createCurrentMonth(Boolean isSave) throws Exception {
        ...
        currentmonth.setMonthname("TXlC3p7eA2vd5DGKUow1LNGxMs5ywqwHyvHXP4mLCvdhAxZreo");
    ...
    public void test2Update() {
        try {
            ...
            currentmonth.setMonthname("y8wufK6WjSpZD9P7JjgLUIbrvz98N34LAAM2lo8HUZIgUiEPcg");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 2, "monthname", "9P2Nh8rxh7sGyHbIBzATDHniikbILXIVxpzCvMuY6oDqSWJRHw2au0P1as6QrH4L3"));
