...
public class CategoryTestCase extends EntityTestCriteria {
    ...
    private Category createCategory(Boolean isSave) throws Exception {
        ...
        category.setCategoryInformation("qWRZauhZhXLaopyDGs38itdytckWxN82tZZFGge7ngyYSpIL58");
    ...
    public void test2Update() {
        try {
            ...
            category.setCategoryInformation("8kvvehg0mbUYDX2oJbKmIhJE4DPEQrMd9I2guAkpwhTrEz4mEm");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(NOT_NULL, 1, "categoryInformation", null));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 2, "categoryInformation", "mUdLkRoYiEWJDcRALjtKrYfZWqfY8wyTbUxpVFT6gghEW4rJDP2dS66WAyu5pEmNW"));
            ...
            try {
                ...
                switch(((contraints.getTestId()))) {
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        category.setCategoryInformation(contraints.getNegativeValue().toString());
                        validateCategory(contraints, category);
                        failureCount++;
                        break;
                }
