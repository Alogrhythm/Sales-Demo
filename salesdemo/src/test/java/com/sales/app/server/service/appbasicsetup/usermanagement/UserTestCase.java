...
public class UserTestCase extends EntityTestCriteria {
    ...
    private User createUser(Boolean isSave) throws Exception {
        ...
        useraccesslevel.setLevelIcon("KCKz1WD6xWAKD8VwBUnMbckXRBvF3awyHSrz794b4HHB7gZH1y");
        useraccesslevel.setUserAccessLevel(valueGenerator.getRandomInteger(99999, 0));
        useraccesslevel.setLevelDescription("eBdBTv5owo85SpPpt8XliyTIWxiUsERYH3cVsqp2YoJxiNgE7z");
        useraccesslevel.setLevelHelp("KQpka72M51iCf5n1sEnMr6uU1B7iHDFVbNV5HHStsQUTFAYdYo");
        useraccesslevel.setLevelName("Yaltb6Jp42NByTFKHTAGMvmllSN2EcCZqtyEBDacmM44HNTW1H");
        ...
        useraccessdomain.setDomainIcon("HIw2nWDdVbbpb3sdh3MwrWVIa7mkG1T4xztYTxIeVUYSlDCXMp");
        useraccessdomain.setDomainDescription("apq0qAmha3akYrPrswBlz7FUYKjVuQqtPxaO7zlWjqNeRhbFvM");
        useraccessdomain.setUserAccessDomain(valueGenerator.getRandomInteger(99999, 0));
        useraccessdomain.setDomainName("7qHWtocUePSZIuDK1jgr3rJaWvIdClOSVvOYNDWonzXOWHRdw0");
        useraccessdomain.setDomainHelp("gKbtRgNxfsIi00QqyAp8cBl5853pWRslW0MZUJMhs5F1Ei1FBQ");
        ...
        user.setUserAccessCode(18233);
        user.setUserAccessDomainId((java.lang.String) UserAccessDomainTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setSessionTimeout(2458);
        user.setIsDeleted(1);
        user.setAllowMultipleLogin(1);
        user.setChangePasswordNextLogin(1);
        user.setLastPasswordChangeDate(new java.sql.Timestamp(1465991071788l));
        user.setPasswordExpiryDate(new java.sql.Timestamp(1465991071788l));
        user.setGenTempOneTimePassword(1);
        user.setMultiFactorAuthEnabled(1);
        user.setPasswordAlgo("ukucf1FErC8PYqqC8AZNAMaJ4R9GB1SUMnSXQYmOchFQ2w0qKT");
        java.util.List<PassRecovery> listOfPassRecovery = new java.util.ArrayList<PassRecovery>();
        PassRecovery passrecovery = new PassRecovery();
        passrecovery.setAnswer("w21wsh7zHAXQIEKgcR12QqinTGhvXSMivoMwEy3fus4Zjwo09j");
        Question question = new Question();
        question.setQuestionDetails("LNcd9NIfAT");
        question.setQuestion("bgrRkqZDSAG3bOr2d9QgKhK4XPaiW279IIw0qBQWYOyWf33VVw");
        question.setLevelid(3);
        question.setQuestionIcon("09ITbApzYZzYnpComF8i0KBzF3H4uUDRlE3gIcUnFDgJGjN9Iz");
        Question QuestionTest = new Question();
        if (isSave) {
            QuestionTest = questionRepository.save(question);
            map.put("QuestionPrimaryKey", question._getPrimarykey());
        }
        passrecovery.setAnswer("zfL9nyuLgDfF7CX1ycqhUebxzsvrDX5crDt7vU2EEouXnOjc8v");
        passrecovery.setUser(user);
        passrecovery.setQuestionId((java.lang.String) QuestionTest._getPrimarykey());
        listOfPassRecovery.add(passrecovery);
        user.addAllPassRecovery(listOfPassRecovery);
        UserData userdata = new UserData();
        userdata.setPassword("EFrBpCmZMVW5LRUxmWFyJG1sNuLoNcYB1m6LyfxBRaJ9HFWdNz");
        userdata.setOneTimePasswordGenDate(new java.sql.Timestamp(1465991071949l));
        userdata.setPassword("lSYh2f7n68qc8sjbDwsnbeFBaAPKTJ2ubP8ZT9UM9DqNksbPNX");
        userdata.setOneTimePasswordGenDate(new java.sql.Timestamp(1465991071958l));
        userdata.setUser(user);
        userdata.setOneTimePasswordExpiry(2);
        userdata.setOneTimePassword("NY8mggUol3buUnpkznd71av5PeAG94BE");
        userdata.setLast5Passwords("yoaSaMzIhT5z4sPG7hqfAPYcxEmT593MnihrMvhsxYOYf3YVZ0");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 1, "userAccessCode", 72069));
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 8, "passwordAlgo", "8yUJvDqQT1S1pPxnr5zf9k4NwdRmnOHHXVuMIpjVsDu533vNYvwiwneZ4FLvcu0ZV"));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 9, "sessionTimeout", 5659));
