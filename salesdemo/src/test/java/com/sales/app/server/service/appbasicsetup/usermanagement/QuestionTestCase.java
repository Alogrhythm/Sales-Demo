...
public class QuestionTestCase extends EntityTestCriteria {
    ...
    private Question createQuestion(Boolean isSave) throws Exception {
        ...
        question.setQuestionDetails("fBtPvNoolL");
        question.setQuestion("uembIbhpFb5BOrinAfThuZcZzQDE0OB7PVhmF5FhbP91Rrbhpr");
        question.setLevelid(6);
        question.setQuestionIcon("RXVWhfO6O4yLkbpuMDQiWDJSE042ZX403w2HdqbhWnS87GBL0N");
    ...
    public void test2Update() {
        try {
            ...
            question.setQuestionDetails("uHYyQC9iHC");
            question.setQuestion("ylomHMAMhEckVdYLU5UL0MM7tdj62vKSuvPhkkrQ1BykeR4V7L");
            question.setVersionId(1);
            question.setLevelid(6);
            question.setQuestionIcon("vhzIGOT0mn6y2Kf39KgUBfU7URwvKBCK6amDPaOKi7vtC6LJHB");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 4, "question", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 5, "questionDetails", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 6, "questionIcon", "9FR6Z8zS68BQrsTDgh52k10KARNk6VLgY9i0FFNdlTOaj7VCUJqIqZQpQu4B69thL"));
